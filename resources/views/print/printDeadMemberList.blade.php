...
<head>
  <meta charset="UTF-8">
  <title>মৃত সদস্যের তালিকা</title>
  <style type="text/css">
    table.nila {
...
<body style="font-family: arial;">
      ...
      <center><h3><span style="font-family:tahoma;border:1px solid #000;padding-top:4px;padding-bottom:4px;padding-left:27px;padding-right:27px;">মৃত সদস্যের তালিকা</span></h3></center>      
      <div class="row">
                ...
                <tr>
                  ...
                  <td>:</td>
                    <td><strong> 
                       ...
                       <?php if($union_id == ""){echo "All"; }else{echo $value1->unpb_name ;} ?>
                    </strong>
                  </td>
