...
<head>
  <meta charset="UTF-8">
  <title>প্রথমিক নির্বাচিত সদস্য সমূহ</title>
  <style type="text/css">
    table.nila {
...
<body style="font-family: arial;">
      ...
      <center><h3><span style="font-family:tahoma;border:1px solid #000;padding-top:4px;padding-bottom:4px;padding-left:27px;padding-right:27px;">প্রথমিক নির্বাচিত সদস্য সমূহ</span></h3></center>      
      <div class="row">
