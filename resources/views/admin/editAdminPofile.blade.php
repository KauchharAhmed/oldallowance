 ...
 <div class="col-md-6">
    ...
    <div class="portlet box blue">
        ...
        <div class="portlet-body form">
            {!! Form::open(['url' =>'adminEditMyProfileInfo','method' => 'post','role' => 'form','class'=>'form-horizontal','files' => true]) !!}
            <div class="form-body">
                ...
                <div class="form-group">
                    <label class="col-md-4 control-label">ই-মেইল<span style="color:red; font-weight: bold">*</span></label>
                    <div class="col-md-8">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control spinner" name="mobile" value="<?php echo $profile_info->mobile; ?>" required=""></div>
                </div>
                <div class="form-group">
